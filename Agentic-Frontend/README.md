...
VITE_API_BASE_URL=https://ollama.example.invalid:8000
VITE_WS_URL=wss://ollama.example.invalid:8000/ws
...
## Testing ##
curl -X POST "https://ollama.example.invalid:8443/api/v1/auth/login-json" \
...
curl -X PUT "https://ollama.example.invalid:8443/api/v1/email/settings" \
...
curl -X PUT "https://ollama.example.invalid:8443/api/v1/email/workflow-settings/default" \
  -H "Authorization: Bearer <TOKEN>" \
  -H "Content-Type: application/json" \
  -d '{
